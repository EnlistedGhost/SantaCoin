...
static const unsigned int MAX_BLOCK_SIZE = 2468482;
...
static const int64_t COIN_YEAR_REWARD_1 = 8 * CENT; // ~8% per year
static const int64_t COIN_YEAR_REWARD_2 = 10 * CENT; // ~10% per year
static const int64_t COIN_YEAR_REWARD_3 = 15 * CENT; // ~15% per year
static const int64_t COIN_YEAR_REWARD_4 = 25 * CENT; // ~25% per year

inline int64_t FutureDrift(int64_t nTime) { return nTime + 15 * 60; }
